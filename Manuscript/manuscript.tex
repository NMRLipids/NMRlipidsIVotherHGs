...
2) glycerol backbone and headgroup strucure and behaviour are similar in model membranes and in bacteria \cite{gally81,scherer87,seelig90}, \\
...
the Ca2+ binding is presumably fully cancels the charge from negative lipids and
...
\begin{displayquote}
  ...
  (phosphatidylglycerol) with approximately the same binding constant of K = 10-20 M$^{-1}$; (ii) the free Ca$^{2+}$
  concentration at the membrane interface is distinctly enhanced if the membrane carries a negative surface
  charge, either due to protein or to lipid; (iii) increased inter-facial Ca$^{2+}$ also means increased amounts
  of bound Ca$^{2+}$ at neutral and charged lipids; (iv) the actual binding step can be described by a Langmuir
