...
\centering
\caption{List of MD simulations of pure PS bilayers without additional salt. % along with the references to the force fields used and the MD trajectories.
...
In this work we use this former definition to be consistent with the reference
...
magnitude small value.
The S-DROSS curve from SIMPSON simulation with a positive value for the smaller  $S_{\rm CH}$ 
...
\begin{figure}[]
  ...
  \caption{\label{HGstructuresPSandPC}
    ...
    (A) C$_\alpha$-C$_\beta$-C$_\gamma$-O$_\gamma$ and  O$_\alpha$-C$_\alpha$-C$_\beta$-N dihedrals
    of the PS headgroup and (B) N-C$_\beta$-C$_\alpha$-O$_\alpha$ and C$_\beta$-C$_\alpha$-O$_\alpha$-P
...
for PS compared to PC (Fig. \ref{HGorderParametersPS} vs. Fig. 2 in Ref.~\citenum{botan15}), in line with
...
%have a narrower distribution in
...
increase when negatively charged POPS lipids are incorporated in the bilayer
