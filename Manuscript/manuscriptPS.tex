...
\resizebox{0.87\textwidth}{!}{\begin{tabular}{lccccccccc}
  ...
  lipid/counter-ions  & force field & {[}CaCl$_{2}${]}\,(M)  & N$_{{\rm l}}$  & N$_{{\rm w}}$  & \footnote{Number of Ca$^{2+}$ cations in the system}N$_{{\rm c}}$  & T (K)  & t$_{{\rm sim}}$(ns)  & t$_{{\rm anal}}$ (ns)  & files\tabularnewline
\hline 
...
POPC:POPS (5:1)  & CHARMM36 \cite{klauda10,venable13} / NBfix1 \cite{kim16}  & 0.26  & 250:50 & 11190  & 53  & 298  & 200  & 180  & \citenum{POPC5POPS1withCaClCHARMM} \tabularnewline
...
\begin{figure*}[tbp]
  ...
  \caption{\label{changesWITHCaClPS}
   Variation of the POPC (left) and POPS (right) headgroup order parameters in a POPC:POPS (5:1) mixture
    ...
    at 298~K (except the data for Berger are from a simulation of POPC:POPS (4:1) mixture at 310~K \cite{ollila07a,melcrova16}). 
    ...
    Potassium counterions were used in MacRog simulations and sodium counterions in Lipid14/17 simulations.
    In CHARMM36 and Berger simulations with added calcium, the charge was neutralized with calcium, and monovalent counterions were not present.
  }
\end{figure*}
