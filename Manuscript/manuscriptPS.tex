...
To evaluate counterion binding in different simulation against experimental data~\cite{roux90},
we plot the headgroup order parameters measured from POPC:POPS 5:1 mixture
as a function of function of different monovalent ions added to the buffer (Fig. \ref{PSresponseTONaCl}). 
\begin{figure*}[]
  \centering
