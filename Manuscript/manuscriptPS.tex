...
\begin{figure}[!htb]
  ...
  \caption{\label{HGorderparametersPCvsPS}
    ...
    Experimental values are from Ref. \citenum{scherer87} with the signs measured in Ref.~\cite{ferreira16}.
  }
...
\begin{figure}[!htb]
  ...
  \caption{\label{HGorderparametersPSvsPC}
    ...
    measured at 298~K in this work and in Ref. \citenum{roux90}, respectively.
...
\begin{figure}[ht]
  ...
  \todo{y-axis scale of Lipid17 should be checked.} \\
...
to the bound cations and to the dilution of bilayer with zwitterionic PC lipids were not
