...
PS headgroup is more rigid than the phosphocholine (PC)
...
to the increased local cation concentration in the membranes vicinity~\cite{seelig90,sinn06}.
...
to understand PS headgroups, their influence on lipid bilayer properties, and their
interaction with
...
However, the results depend strongly on the force field used.
...
lipid bilayers is overestimated \cite{catte16}. Based on these data, the cation binding
affinity to POPC bilayer has since been improved by implicitly including the electronic polarizability
