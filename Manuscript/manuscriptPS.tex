...
affinity, increase the area per molecule from 53 $\AA^2$ to 63 $\AA^2$ in MacRog simulations.
...
(section \ref{mixtureTOadditionalCIs} in the supplementary information).
...
with increasing amount of PS.
Therefore, the relatively weak binding of potassium
