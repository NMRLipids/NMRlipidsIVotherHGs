...
\caption{List of MD simulations. The salt concentrations calculated as 
   ...
   CKP-TMA$^+$ refers to the version with Berger/Chiu NH$_3$ charges compatible with Berger
   (i.e. the NH$_3$ group having the same charges as in the N(CH$_3$)$_3$ group of the PC lipids)
   and CKP-Lys refers to the version with more Gromos compatible version
...
\begin{tabular}{l c c r r r r r r c c}
 ...
 lipid/counter-ions & force field for lipids / ions & NaCl (mM) & CaCl$_2$\,(mM) &  \footnote{Number of lipid molecules with largest mole fraction}N$_{\rm l}$   &  \footnote{Number of water molecules}N$_{\rm w}$   & \footnote{Number of additional cations}N$_{\rm c}$  & \footnote{Simulation temperature}T (K)  & \footnote{Total simulation time}t$_{{\rm sim}}$(ns) & \footnote{Time used for analysis}t$_{{\rm anal}}$ (ns) &   \footnote{Reference for simulation files}files\\
  \hline
    ...
    POPS/Na$^+$  & GROMOS-CKP-TMA$^+$ \cite{??} \todoi{Correct citation(s) for CKP.} &0 & 0  & 128 & 4480 & 0  & 298  & 500 & 100 & \cite{ckp1POPS303K} \\
    POPS/Na$^+$  & GROMOS-CKP-Lys \cite{??} \todoi{Correct citation(s) for CKP.} &0 & 0  & 128 & 4480 & 0  & 298  & 500 & 100 & \cite{ckp2POPS303K} \\
...
\begin{figure}[]
  ...
  \todo{In table \ref{IONsystems}: ''CKP1 referes to the version with  
    ...
    also in this figure?
    A: YES. Renamed CKPs to clarify this.} \\
\end{figure}
...
\todo{It would be probably better to use datasets for NaCl and KCl from Ref. \citenum{roux90}
to compare monovalent ion binding to PS containing bilayer.}
