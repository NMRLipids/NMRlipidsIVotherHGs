...
As previously observed for PC lipids, the order parameters and structures
of headgroup and glycerol backbone show wide variety between different simulation
models for PS lipids (Figs. \ref{HGorderParametersPS} and \ref{HGstructuresPS}).
The models for PS lipids perform generally less well than for
...
from simulations is not straightforward. The two best performing models,
Slipids and CHARMM36, reproduce the larger forking of the $\alpha$-carbon 
