...
Therefore, it is crucial to resolve the structural details
of PS headgroup and calcium binding in order to fully
understand PS mediated signaling processes.
...
Some studies propose specific binding of calcium directly to PS lipid
headgroups \cite{??}, while others propose that only the local concentration
of cations in the vicinity of negatively charged membranes containing PS lipids
and that the binding constant of cations is similar
...
In contrast to PC lipids discussed previously \cite{botan15,catte16},
systems with negatively charged lipids always contains counterions.
Since the ion binding changes the headgroup order parameters \cite{seelig87,catte16},
the counterion distribution have to be taken into account also
when additional ions are not present.
The Na+ density profiles from different simulation are shown in Fig. \ref{NAdensPOPS}.
\begin{figure}[]
  \centering
  \includegraphics[width=9.0cm]{../Figs/NAdensPOPS.eps}
  \caption{\label{NAdensPOPS}
    Sodium density of POPS lipid bilayer along the membrane normal from
...
concetrations gives a good agreemet with experiments.
