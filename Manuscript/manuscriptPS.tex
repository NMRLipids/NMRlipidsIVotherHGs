...
In addition, the comparison of N-C$_\beta$-C$_\alpha$-O$_\alpha$ dihedral between PC and PS headgroups
from CHARMM36 simulations, which are in best agreement with experiments for both lipids,
shows a more asymmetric and restricted
rotations around this bond (Figs.~\ref{HGstructuresPSandPC} b) and \ref{dihedralsHGpc}).
These results might manifest the increased rigidity anticipated from the early experimental studies \cite{browning80,buldt81}.
Also the dihedral distributions and sampled conformations of glycerol backbone region
from different models are shown in the supplementary information
