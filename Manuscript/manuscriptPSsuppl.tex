...
The data are available from Refs. \citenum{??} \todo{J. Madsen, please write simulation details}. \\
...
from Ref.~\cite{10.1016/j.dib.2015.09.013}. The bilayer was hydrated by a total of 5120 water 
molecules, corresponding to 40 water molecules per lipid.

The MacRog lipid parameters \cite{10.1016/j.chemphyslip.2015.07.002}, obtained from 
\cite{10.1016/j.dib.2015.09.013}, were used, along with the TIP3P water model 
\cite{10.1063/1.445869}. The simulation parameters were identical to those used for 
...
were described by the \AA{}qvist parameters \cite{10.1021/j100384a009}. Other topologies
...
two leaflets were set up using CHARMM-GUI \cite{10.1002/jcc.20945}.
...
The lipids were described using the MacRog model \cite{10.1021/jp5016627,10.1016/j.chemphyslip.2015.07.002,10.1016/j.dib.2016.03.067}. The POPC topologies were obtained from 
Ref.~\citenum{10.1016/j.dib.2015.09.013}, whereas the POPS topology was adapted from 
Ref.~\citenum{10.1016/j.dib.2016.03.067}. Notably, the chains were reversed in order to modify 
OPPS into POPS. Unlike the D stereoisomer present in Ref.~\cite{10.1016/j.dib.2016.03.067}, the 
POPS head group conformations generated by CHARMM-GUI are in the naturally occurring L stereoisomer.
TIP3P model \cite{10.1063/1.445869} was used for water, and the \AA{}qvist parameters 
\cite{10.1021/j100384a009}, standard for the OPLS force field, were employed for the ions. 

The simulation parameters were taken from Ref.~\citenum{10.1016/j.dib.2016.03.067}. 
...
\cite{10.1063/1.470117} was used for electrostatics. Dispersion correction \cite{10.1021/jp0735987} 
was applied to both energy and pressure. Temperature was kept constant at 298~K using the 
Nos\'{e}--Hoover thermostat \cite{10.1063/1.447334,10.1103/PhysRevA.31.1695}. The lipids and 
...
\cite{10.1063/1.328693}. All non-water bonds were constrained with the LINCS algorithm 
\cite{10.1002/(SICI)1096-987X(199709)18:12<1463::AID-JCC4>3.0.CO;2-H,10.1021/ct700200b},
whereas the bonds in water molecules were constrained using SETTLE \cite{10.1002/jcc.540130805}.
...
\subsection{Lipid17}
{\it DOPS and POPS bilayers.} \\
The data in Table \ref{PSsystems} and Refs \citenum{lipid17POPSjcions,lipid17POPSff99ions,lipid17DOPSjcions,lipid17DOPSff99ions}
...
The data in Table \ref{mixedIONsystems} and Refs \citenum{POPCpopsLIPID17withKCI,POPCpopsLIPID17withK,POPCpopsLIPID17withNaCI,POPCpopsLIPID17withNa}
\todo{B. Kav and M. Miettinen, please write simulation details} \\

\noindent
{\it POPC:POPS (5:1) mixtures with additional calcium} \\
The data in Table \ref{mixedIONsystems} and Refs \citenum{lipid17_cacl_series}
