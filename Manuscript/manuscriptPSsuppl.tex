...
\pagebreak
\section{Effect of the definition of concentration on the headgroup order parameters as a function of ion concentration.}\label{concentrationDEFfigure}
...
\begin{figure}[]
  ...
  \caption{\label{concentrationDEFfigure}
    ...
    lipids (buffer concentration) and concenrtration in bulk after solvating the lipids (bulk concentration) \cite{melcr18}. 
}
\end{figure}
