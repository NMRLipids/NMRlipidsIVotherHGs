...
\pagebreak
\section{Sensitivity of the molecular electrometer to the chosen definition of ion concentration}
...
of to added sodium and potassium are not in line with the experiments. Instead, the simulations produces a response similar to experiments conducted in LiCl (Fig. \ref{PSresponseTONaCl}), indicating overestimated binding affinity of sodium and potassium 
...
are underestimated in simulations of POPC:POPS (5:1) mixture with CHARMM36 when employing NBfix (as obtained from CHARMM\_GUI in January 2018) for interactions between calcium and lipid oxygens \cite{kim16}
